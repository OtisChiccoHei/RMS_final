...
class ForwardPolicy
{
    ...
    {
        return $user->can('view_any_forward');
    }
    ...
    {
        return $user->can('create_forward');
    }
    ...
    {
        return $user->can('update_forward');
    }
    ...
    {
        return $user->can('delete_forward');
    }
    ...
    {
        return $user->can('delete_any_forward');
    }
     ...
     */
    public function replicate(User $user, Forward $forward): bool
    {
